...
class ViewBookedPage extends StatelessWidget {
  final HomeControllerCopy controller = Get.find<HomeControllerCopy>();

  ViewBookedPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Booked Houses"),
